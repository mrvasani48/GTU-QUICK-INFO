...
<head>
    ...
    <link rel="stylesheet" href="student_courner.css">
</head>
<body>      
    <div class="container1">
        ...
        <div class="box2">
             ...
             <a class="pnav"  id="active" href="home_page.php">Home</a>
                ...
                <a class="pnav active" href="#">Stu. Zone</a>
                ...
                <a class="pnav" href="d1footer">Contact us</a>
             </div>
        </div>
    </div>
    <div class="main">
 <a href="#" class="sz">Admission Sources</a>
 <a href="#" class="sz">Alumni Association</a>
 <a href="#" class="sz">Campus Connect</a>
 <a href="#" class="sz">Convocation</a>
 <a href="#" class="sz">College Activity</a>
 <a href="#" class="sz">Co-Curricular Activity</a>
 <a href="#" class="sz">Exam schedule</a>
 <a href="#" class="sz">Foreign Student Cell</a>
 <a href="#" class="sz">IDP / UDP</a>
 <a href="#" class="sz">Institute/Univercity Transfer</a>
 <a href="#" class="sz">Mark sheet</a>
 <a href="#" class="sz">Student Courner</a>
 <a href="#" class="sz">Student Grade History</a>
 <a href="#" class="sz">Training & Placement</a>
 </div>
