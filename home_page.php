...
<div class="container1">
        ...
        <div class="box2">
             ...
             <div class="box2in2">
                <a class="pnav active" href="home_page.php">Home</a>
...
<div>       
   ...
   <h1 style="text-align:center; clear:left; clear:right; ">cources</h1>
    <section id="cources">
                 ...
                 <div id="cources1">
                     <img id="couresimg" src="image/GTU1.jpg" height="200px" width="200px">
                     <p id="couresname" ><a id="csnm" href="#">Diploma Engineering</a></p>
               </div>
               <div id="cources1">
                     <img id="couresimg" src="image/GTU2.jpg" height="200px" width="200px">
                     <p id="couresname" ><a id="csnm" href="#">Diploma Pharmacy</a></p>
               </div>
               <div id="cources1">
                     <img id="couresimg" src="image/GTU4.jpg" height="200px" width="200px">
                     <p id="couresname" ><a id="csnm" href="#">Bachelor of Engineering</a></p>
               </div>
               <div id="cources1">
                     <img id="couresimg" src="image/GTU5.jpg" height="200px" width="200px">
                     <p id="couresname" ><a id="csnm" href="#">Bachelor of Pharmacy</a></p>
               </div>

               <div id="cources1">
                     <img id="couresimg" src="image/GTU6.jpg" height="200px" width="200px">
                     <p id="couresname" ><a id="csnm" href="#">Bachelor of Architecture</a></p>
               </div>
             
               <div id="cources1">
                     <img id="couresimg" src="image/GTU7.jpg" height="200px" width="200px">
                     <p id="couresname" ><a id="csnm" href="#">Bachelor of Hotel Management and Catering Technology</a></p>
               </div>
               <div id="cources1">
                     <img id="couresimg" src="image/GTU8.jpg" height="200px" width="200px">
                     <p id="couresname" ><a id="csnm" href="#">Master of Engineering</a></p>
               </div>
               <div id="cources1">
                     <img id="couresimg" src="image/GTU9.jpg" height="200px" width="200px">
                     <p id="couresname" ><a id="csnm" href="#">Master of Computer Applications</a></p>
               </div>
               <div id="cources1">
                     <img id="couresimg" src="image/GTU10.jpg" height="200px" width="200px">
                     <p id="couresname" ><a id="csnm" href="#">Master of Business Management</a></p>
               </div>
               <div id="cources1">
                     <img id="couresimg" src="image/GTU11.jpg" height="200px" width="200px">
                     <p id="couresname" ><a id="csnm" href="#">Master of Pharmacy</a></p>
               </div>
               <div id="cources1">
                     <img id="couresimg" src="image/GTU12.jpg" height="200px" width="200px">
                     <p id="couresname" ><a id="csnm" href="#">Master in Applied Management</a></p>
               </div>
               <div id="cources1">
                     <img id="couresimg" src="image/GTU13.jpg" height="200px" width="200px">
                     <p id="couresname" ><a id="csnm" href="#">Master in Technology Management</a></p>
               </div>
               <div id="cources1">
                     <img id="couresimg" src="image/GTU14.jpg" height="200px" width="200px">
                     <p id="couresname" ><a id="csnm" href="#">Master in Pharmacy Management</a></p>
               </div>
               <div id="cources1">
                     <img id="couresimg" src="image/GTU15.jpg" height="200px" width="200px">
                     <p id="couresname" ><a id="csnm" href="#">Master of Philosophy</a></p>
               </div>
               <div id="cources1" >
                     <img id="couresimg" src="image/GTU16.jpg" height="200px" width="200px">
